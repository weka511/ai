...
File  | Remarks |
--------------------|-------------------------------------------------------------------------------------------
ai.py| Common code for demos
pymdp_demo.py|[Conor Heins et al--pymdp: A Python library for active inference in discrete state spaces](https://arxiv.org/abs/2201.03904)
